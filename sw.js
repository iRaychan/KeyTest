/* KeySuite V3.8.6 service worker — full repository build, network first */
const CACHE='keysuite-v386';
const SHELL=[
 ...
 './universe.js','./v386-dashboard-keycore.js','./selector/index.html','./selector-es/index.html','./selector-es/es-core.js',
