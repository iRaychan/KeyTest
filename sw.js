const CACHE='keysuite-v219';
const SHELL=['./','./index.html','./permissions.js','./app.js','./assembly.js','./quotation-templates.js','./pricing.js','./categories.js','./pricelist.js','./product.js','./manifold.js','./roles.js','./auth.js','./manifest.json','./keylargo-logo.png'];
