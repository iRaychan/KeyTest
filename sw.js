/* KeySuite V3.8.5 service worker — full repository build, network first */
const CACHE='keysuite-v385';
const SHELL=[
 ...
 './universe.js','./v385-dashboard-keycore.js','./selector/index.html','./selector-es/index.html','./selector-es/es-core.js',
