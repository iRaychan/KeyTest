const CACHE='keysuite-v209';
const SHELL=['./','./index.html','./permissions.js','./app.js','./assembly.js','./pricing.js','./categories.js','./pricelist.js','./product.js','./roles.js','./auth.js','./manifest.json','./keylargo-logo.png'];
